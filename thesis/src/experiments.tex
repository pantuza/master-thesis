...
\section{Consumo de processador no processo do controlador}

O consumo da unidade central de processamento (CPU) no processo do controlador
foi medido através da biblioteca utilitária \emph{sysstat} 
\citep{sebastien2015sysstat}.

Um experimento variando o número de computadores na rede permitiu coletar 
os dados do consumo de CPU.
Coletou-se durante 30 segundos a utilização da CPU do processo para cada 
...
utilização de CPU segue quase linearmente. 
